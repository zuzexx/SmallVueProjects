<template>
  <main class="flex items-center justify-center min-h-screen bg-slate-800">
    <div
      class="flex flex-col md:flex-row my-6 space-y-6 md:space-y-0 md:space-x-6 md:my-0"
    >
      <div class="bg-slate-700 rounded-xl text-slate-200">
        ...
        <div class="p-8 mx-3 mb-3 rounded-b-xl bg-slate-800">
          <ul class="flex flex-col space-x-2">
            <li class="flex justify-center">
              ...
              <p class="text-sm ml-1">100 GB of storage</p>
            </li>
            ...
            <li class="flex justify-center">
              ...
              <p class="text-sm ml-1">Option to add members</p>
            </li>
            ...
            <li class="flex justify-center">
              ...
              <p class="text-sm ml-1">Extra member benefits</p>
            </li>
          </ul>
        </div>
      </div>
      <div class="bg-violet-600 rounded-xl text-slate-200">
        <div class="p-8 mx-3 mt-3 rounded-t-xl bg-slate-800">
          ...
          <div class="flex justify-center">
            <a
              href="#"
              class="inline-block px-10 py-3 my-6 text-center border border-violet-600 bg-violet-600 rounded-lg hover:bg-violet-800 hover:border-violet-800 duration-200"
              >Purchase</a
            >
          </div>
          <div class="border-t border-slate-700"></div>
        ...
        <div class="p-8 mx-3 mb-3 rounded-b-xl bg-slate-800">
          <ul class="flex flex-col space-x-2">
            <li class="flex justify-center">
              ...
              <p class="text-sm ml-1">200 GB of storage</p>
            </li>
        ...
        <div class="p-8 mx-3 mb-3 rounded-b-xl bg-slate-800">
          <ul class="flex flex-col space-x-2">
            <li class="flex justify-center">
              ...
              <p class="text-sm ml-1">2 TB of storage</p>
            </li>
